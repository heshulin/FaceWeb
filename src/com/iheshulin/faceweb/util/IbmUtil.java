...
public class IbmUtil {
    ...
    public  IbmUtil(){
        final String username = "7cb477a5-594f-40a3-858a-0f5fa3e56b02";
        final String password = "izc1ia6126e8";
        try {
    ...
    public String useMe(String text){

        IbmUtil ibmUtil = new IbmUtil();
        String result = ibmUtil.getResult(text);
